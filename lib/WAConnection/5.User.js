...
class WAConnection extends _4_Events_1.WAConnection {
    ...
    async getStatus(jid) {
        const status = await this.query({ json: ['query', 'Status', jid || this.user.jid], expect200: true });
        return status;
    }
     ...
     */
    async loadChats(count, before, searchString) {
        let db = this.chats;
        if (searchString) {
            db = db.filter(value => { var _a, _b; return ((_a = value.name) === null || _a === void 0 ? void 0 : _a.includes(searchString)) || ((_b = value.jid) === null || _b === void 0 ? void 0 : _b.startsWith(searchString)); });
        }
