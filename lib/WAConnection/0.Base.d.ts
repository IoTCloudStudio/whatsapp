...
import { AuthenticationCredentials, WAUser, WANode, WATag, MessageLogLevel, DisconnectReason, WAConnectionState, AnyAuthenticationCredentials, WAContact, WAChat, WAQuery, ReconnectMode, WAConnectOptions } from './Constants';
...
export declare class WAConnection extends EventEmitter {
    ...
    protected lastConnectTime: Date;
     ...
     * recieved JSON
     */
    query({ json, binaryTags, tag, timeoutMs, expect200, waitForOpen }: WAQuery): any;
    /**
     ...
     */
    protected sendBinary(json: WANode, tags: WATag, tag?: string): string;
    /**
     ...
     * @return the message tag
     */
    protected sendJSON(json: any[] | WANode, tag?: string): string;
    /** Send some message to the WhatsApp servers */
    protected send(m: any): void;
    protected waitForConnection(waitForOpen?: boolean): Promise<void>;
    /**
