...
exports.extensionForMediaMessage = exports.decodeMediaMessageBuffer = exports.generateThumbnail = exports.generateProfilePicture = exports.compressImage = exports.getMediaKeys = exports.decryptWA = exports.generateMessageID = exports.generateClientID = exports.generateMessageTag = exports.openWebSocketConnection = exports.promiseTimeout = exports.delayCancellable = exports.delay = exports.unixTimestampSeconds = exports.randomBytes = exports.hkdf = exports.sha256 = exports.hmacSign = exports.aesEncrypWithIV = exports.aesEncrypt = exports.aesDecryptWithIV = exports.aesDecrypt = exports.isGroupID = exports.whatsappID = exports.waChatUniqueKey = exports.Browsers = void 0;
...
exports.openWebSocketConnection = (timeoutMs, retryOnNetworkError) => {
    const newWS = async () => {
        const conn = new ws_1.default('wss://web.whatsapp.com/ws', null, { origin: 'https://web.whatsapp.com', timeout: timeoutMs });
    ...
    const connect = async () => {
        ...
        throw Constants_1.CancelledError();
    };
